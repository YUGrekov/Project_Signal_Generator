...
path_rus_text_column = 'D:\\Development\\DataPrjGen\\Project_Signal_Generator\\rus_dicts.json'
...
#         if split_str[0] == 'path_rus_text_column':
#             path_rus_text_column  = split_str[1]
...
#                        'drawdown':'Сработка', 'reference_to_value':'Ссылка на значение', 'msg_priority_0':'Приоритет\nсообщения при 0', 
#                        'msg_priority_1':'Приоритет\nсообщения при 1', 'sound_msg_0': 'Звук\nсообщения при 0', 'sound_msg_1': 'Звук\nсообщения при 1',
...
#             'prj_tm': {'id':'№','variable':'Переменная', 'tag':'Идентификатор', 'name':'Название', 'unit':'Единица измерения', 'used':'Используется', 'value_ust':'Значение уставки', 'minimum':'Минимум', 
#                        'maximum':'Максимум', 'group_ust':'Группа уставок', 'rule_map_ust':'Правило для карты уставок'},
...
# import json
# with open("test_nested.json", "w", encoding='utf-8') as outfile:
#     json.dump(rus_list, outfile, ensure_ascii=False, indent=4)
