...
class Diskrets():
    ...
    def check_table(self):
        ...
        if not result_tb_signals:
            self.logsTextEdit.logs_msg('''SQL. DO. Таблица
            ...
            if not result:
                self.logsTextEdit.logs_msg('''SQL. DO. Таблица do
                                           отсутсвует''', 2)
    ...
    def module_calc(self, uso, basket, module):
        ...
        try:
            ...
            if len(hw) > 1:
                self.logsTextEdit.logs_msg(f'''SQL. DO.
            ...
            self.logsTextEdit.logs_msg(f'''SQL. DO. {uso}.A{basket}_{module},
